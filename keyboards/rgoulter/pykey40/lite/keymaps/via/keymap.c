...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_TAB,  LWR_ESC,    KC_SPC,        RSE_ENT, KC_DEL,  KC_RALT, KC_RGUI, KC_RCTL
),
...
[_ADJUST] = LAYOUT_planck_mit(
    _______, QK_BOOT, DB_TOGG, _______, _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, _______, _______,
